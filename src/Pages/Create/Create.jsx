...
export default function Create() {
    ...
    return (
        ...
        <S.Form onSubmit={submitHandler}>
            ...
            <S.Input type='text' placeholder='Nome do personagem' onChange={e => setName(e.target.value)} required/>
            <S.Input type='text' placeholder='URL da imagem' onChange={e => setUrl(e.target.value)} required/>
            <S.Select type='text' placeholder='Raça' onChange={e => setRaca(e.target.value)} required>
            ...
            <S.Select type='text' placeholder='Raça' onChange={e => setSaga(e.target.value)} required>
            ...
            <S.Input type='number' min='0' placeholder='Poder de luta' onChange={e => setPoder(e.target.value)} required/>
            <S.Button type='submit' secondary>Cadastrar personagem</S.Button>
        </S.Form>
        </>
    )
}
